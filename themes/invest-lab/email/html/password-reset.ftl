  ...
  <tr>
    <td>
      <div style="display: inline-block; background: rgba(2, 150, 224, 0.12); border: 1px solid rgba(2, 150, 224, 0.3); border-radius: 12px; padding: 12px 16px;">
        ...
        <span style="color: #0296e0; font-weight: 700; font-size: 14px; margin-left: 8px; vertical-align: middle;">PASSWORD RESET</span>
      </div>
    </td>
  </tr>
</table>
...
<p style="color: #cbd5e1; font-size: 15px; line-height: 1.6; margin: 0 0 28px 0;">
  We received a request to reset the password for your <strong>InvestLab</strong> account. Click the button below to choose a new password:
</p>
...
<div style="background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.25); border-radius: 8px; padding: 16px;">
  <p style="color: #f87171; font-size: 13px; line-height: 1.5; margin: 0;">
    ⚠️ <strong>Didn't request this?</strong> If you didn't request a password reset, you can safely ignore this email. Your password will remain unchanged and your account stays secure.
  </p>
</div>
</@layout.emailLayout>
